export const en = {
  ...
  home: {
    ...
    verdictBadSub: 'Scout the week below for a better window.',
    verdictDoneSub: 'Tomorrow is already scored below.',
    todayBlocks: 'Today’s blocks',
    suggestions: 'Go out & play',
    suggestionsEmpty:
      'No great windows in sight for your favorite activities — check the Week tab for the least risky blocks.',
    bestWindow: 'Great {activity} window',
