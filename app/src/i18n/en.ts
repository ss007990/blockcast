export const en = {
  ...
  home: {
    ...
    next7: 'Next 7 days',
    next7Fine: 'low → high, shared scale · dot = now',
    // captions for the other daily metrics; {u} is the display unit
    next7FineWind: 'sustained → gusts, {u} · shared scale',
    next7FineRain: 'chance of precipitation · total in {u}',
    next7FineSnow: 'snowfall total, {u} · shared scale',
  ...
  location: {
    ...
    following: 'Following your device',
    pinned: 'Pinned spot',
    locating: 'Locating…',
    denied: 'Location is off for BlockCast. Turn it on in your device settings.',
    unavailable: 'Couldn’t get your position. Tap to try again.',
    lastUsed: 'Last used',
    layerSat: 'Satellite',
    layerMap: 'Map',
  },
